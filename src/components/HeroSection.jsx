...
const HeroSection = () => {
  ...
  return (
    <div className='py-6 sm:py-10 lg:py-16 w-full grid grid-cols-5 bg-amethyst-50 dark:bg-amethyst-950'>
      ...
      <div className='col-span-3 text-gray-900 dark:text-gray-100 flex flex-col items-center justify-between gap-4 sm:gap-6 lg:gap-10 h-full z-10 text-center'>
        ...
        {!isLoggedIn ? (
          <Link
            href='/sign_up'
            className='mt-auto text-sm sm:text-xl lg:text-3xl font-bold rounded bg-coral-tree-700 text-white p-2 sm:p-4 font-body'
          >
